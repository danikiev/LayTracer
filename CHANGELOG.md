...
- a visual sensitivity example showing scaled traveltime and ray-parameter effects, local model prediction, and dense nearby source-receiver traveltime prediction from sparse exact anchor rays
